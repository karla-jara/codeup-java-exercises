...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("prices[0] = " + prices[0]);
        System.out.println("sidesArray[0] = " + sidesArray[0]);
        System.out.println("groceryList[0] = " + groceryList[0]);

        //TODO Together: What if we try to refer to an index beyond what we have set up?
//        System.out.println("sidesArray[6] = " + sidesArray[6]); // we will get an error bc there is only 5 elements in array
        ...
        String [] cousins = {"Silvia", "Jean-Paul", "Maribel", "Dennis", "Robbie", "Alejandra", "Paula", "Adriana"};
        System.out.println("cousins = " + cousins[5]);
        ...
        for(int i = 0; i < cousins.length; i++){
            System.out.println("This is the name of one of my cousins " + cousins[i] + ".");
        }
        ...
        for(String cousin : cousins){
            System.out.println("Karla has many family members, a few of them are " + cousin);
        }
...
//        }
        ...
        System.out.println("Arrays.toString(cousins) = " + Arrays.toString(cousins));
        String cousinsNameString = (Arrays.toString(cousins).replace("[", "").replace("]", ""));

        System.out.println(cousinsNameString + " cousins are reporting for duty");
        ...
        System.out.println("Arrays.binarySearch(cousins, \"Paula\") = " + Arrays.binarySearch(cousins, "Paula"));
...
//        System.out.println("Deploying MIB personnel to counter alien activity!");
        System.out.println("MIB Officer Alejandra headed to grid area " + matrix[1][2] + "!"); //should say "grid area 6!"
        System.out.println("MIB Officer Dennis headed to grid area " + matrix[2][0] + "!"); //should say "grid area 7!"
        System.out.println("MIB Officer Gilbert headed to grid area " + matrix[0][1] + "!"); //should say "grid area 2!"
