public class ControlStatementsLoopsLec {
    public static void main(String [] args){
        ...
        // Boolean Expressions that evaluate to true (5==5//true, 5<6//true, 5>6//false)
        ...
        //Logical operators allow us to combine multiple boolean values to produce a single boolean value.

        boolean isLoggedIn = true;
        boolean isOwner = true;
        System.out.println("(isAdmin && isLoggedIn) = " + (isAdmin && isLoggedIn) + ". Do I reveal the hidden admin portal? " + (isAdmin && isLoggedIn));

        // (6>9).soutv // short for typing code below
