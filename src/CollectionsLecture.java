...
public class CollectionsLecture {
    ...
    public static void main(String[] args) {
        ...
        classmates.add("Felishia");
        classmates.add("Nathan");
        classmates.add("Alex");

        System.out.println("classmates.get(0) = " + classmates.get(0));
        System.out.println("classmates.get(1) = " + classmates.get(1));
        System.out.println("classmates.get(2) = " + classmates.get(2));
